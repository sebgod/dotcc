...
**C99**
- 🟡 Compound literals — `(struct S){…}` ✅ (struct/union, any position); `(int[]){…}` ✅ (array, initializer position → stackalloc); scalar `(int){5}` ⛔. See the Types table.
